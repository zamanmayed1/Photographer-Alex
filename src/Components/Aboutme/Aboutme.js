...
const Aboutme = () => {
          return (
                    <div className='border p-5 md:w-2/4  mx-auto text-left mb-52 '>
                              ...
                              <div className="social w-2/4 md:1/4 grid grid-cols-4 gap-4 mx-auto my-3">
                             <a href="https://www.facebook.com/zamanmayed/"> <img className='w-10 rounded-full' src="https://i.ibb.co/5Gfq8Bf/icons8-facebook-circled.gif" alt="" /></a>
                              <img className='w-10 rounded-full' src="https://i.ibb.co/WGRh8gD/icons8-twitter-circled.gif" alt="" />
                              <img className='w-10 rounded-full' src="https://i.ibb.co/Y2KCZjc/icons8-linkedin-2.gif" alt="" />
                              <img className='w-10 rounded-full' src="https://i.ibb.co/JmVS5Dq/icons8-youtube-logo.gif" alt="" />
                              </div>
