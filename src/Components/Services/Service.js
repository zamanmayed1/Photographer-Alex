...
const Service = ({ service }) => {
        ...
        return (
                <div className='service relative  p-3'>
                        ...
                        <Link to={'/checkout'}><button className='md:w-2/4 mx-auto border font-bold border-orange-400  hover:text-orange-400 text-xl py-1   text-white px-2 mt-4'>Book Now</button></Link>
                </div>
        );
};
